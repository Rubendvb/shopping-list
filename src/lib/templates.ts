...
export const TEMPLATES: Template[] = [
  {
    ...
    items: [
      ...
      { name: 'Lava Louças', quantity: 1, unit: 'UN', categoryId: 'cat-limpeza', priority: 'HIGH' },
      {
        name: 'Sabão em Pasta',
        quantity: 1,
        unit: 'UN',
      ...
      {
        name: 'Leite Líquido Integral 1L',
        quantity: 2,
        unit: 'L',
      ...
      {
        name: 'Filé Peito Frango',
        quantity: 1,
        unit: 'KG',
        categoryId: 'cat-acougue',
        priority: 'HIGH',
      },
      ...
      { name: 'Sal', quantity: 1, unit: 'KG', categoryId: 'cat-mercado', priority: 'MEDIUM' },
      {
        name: 'Molho Tomate 300g',
        quantity: 1,
        unit: 'KG',
